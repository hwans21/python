...
- 인수는 함수를 호출할 때 함수 실행에 필요한 값을 전달하는
...
- 반환값이란 함수를 호출한 곳으로 함수의 최종 실행결과를
전달하는 값입니다.
...
print(add(5,7), add(9,8)) # print(12, 17)

# n = int(input('정수: 3'))-> n = int('3')

# 만약 여러 개의 값을 한번에 return해야 할 때는
# 컬랙션 자료형을 사용합니다.(list,set,tuple,dict ....)

def operate_all(n1,n2):
    return n1+n2, n1-n2, n1*n2, n1/n2 # tuple로 리턴
    # return n1-n2
    # return n1*n2
