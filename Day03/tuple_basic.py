...
값을 한 번 저장한 후에는 내부 요소의 편집이 불가능 합니다.
...
# tu[2]=19 (x) TypeError: 'tuple' object does not support item assignment
# tu[1:3] = 13,15,17 (x) TypeError: 'tuple' object does not support item assignment
# tu.append(10) (x) AttributeError: 'tuple' object has no attribute 'append'
# del(tu[0]) (x) TypeError: 'tuple' object doesn't support item deletion
